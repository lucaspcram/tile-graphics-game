...
public class AnimationLoader {
	...
	public static void loadAnimations() {
		...
		for(int i = 0; i < tallGrass.length; i++) {
			resourceManager.loadImage("res/img/tiles/grasscover" + (i + 1) + ".png", "GrassCoverImg" + i);
		...
		for(int i = 0; i < beetle.length; i++) {
			resourceManager.loadImage("res/img/entities/beetle"+ (i + 1) +".png", "BeetleImg" + i);
	...
	public static Animation getAnimation(String animationName) {
		Animation anim = null;
		try {
			anim = new Animation(resourceManager.getAnimationResource(animationName).getAnimation());
