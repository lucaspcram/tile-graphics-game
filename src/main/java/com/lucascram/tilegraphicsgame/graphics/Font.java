...
public class Font {
	...
	//Precondition: Parameter 'String message' contains only spaces (ASCII 32), capital letters A-Z and/or digits 0-9
	public void render(Graphics2D g2d, String message, int xPos, int yPos, int sizeScale) {
		...
		for(int i = 0; i < message.length(); i++) {
			...
			g2d.drawImage(characterImages[index], startX + (i * width), startY, width, height, null);
		}
	}
}
