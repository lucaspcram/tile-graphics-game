...
public class GameStateManager {
    ...
    private void initStates(ActionEngine actionEngine) {
        gameStates.add(
                NUMGAMESTATES++, new LoadingScreenState(LOADING_SCREEN_STATE_NAME, actionEngine));
        gameStates.add(
                NUMGAMESTATES++, new TitleScreenState(TITLE_SCREEN_STATE_NAME, actionEngine));
        ...
        gameStates.add(
                NUMGAMESTATES++, new ScoreScreenState(SCORE_SCREEN_STATE_NAME, actionEngine));
    }
    ...
    public AbstractGameState getCurrentState() {
        ...
        try {
            ...
            DebugDumper.handleException(
                    null, DebugDumper.ERR_MESSAGE_GAMESTATE, e.getStackTrace(), e);
        }
