        ...
        for (int i = 0; i < BG_WIDTH; i++) {
            for (int j = 0; j < BG_HEIGHT; j++) {
                if (RandomUtility.percentChance(40)) {
                    background[i][j] =
                            new Sprite(
                                    i * WorldRenderer.PIXEL_WIDTH,
                                    j * WorldRenderer.PIXEL_HEIGHT,
                                    true);
                    background[i][j].addAnimation(
                            AnimationLoader.getAnimation(AnimationLoader.GRASS_TILE));
                    ...
                    background[i][j] =
                            new Sprite(
                                    ...
                                    true);
                    background[i][j].addAnimation(
                            AnimationLoader.getAnimation(AnimationLoader.DIRT_TILE));
                    background[i][j].setAnimation(0);
                }
            }
        }
                ...
                if (RandomUtility.percentChance(10)) {
                    background[i][j] =
                            new Sprite(
                                    ...
                                    true);
                    background[i][j].addAnimation(
                            AnimationLoader.getAnimation(AnimationLoader.WATER_TILE));
                    background[i][j].setAnimation(0);
                }
                ...
                if (RandomUtility.percentChance(1)) {
                    background[i][j] =
                            new Sprite(
                                    ...
                                    true);
                    background[i][j].addAnimation(
                            AnimationLoader.getAnimation(AnimationLoader.ANT_HILL_TILE));
                    background[i][j].setAnimation(0);
                }
            }
        }
